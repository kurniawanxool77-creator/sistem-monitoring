        ...
        <nav className="flex-1 overflow-y-auto py-4 px-3">
          {menuItems.map((section, idx) => (
            <div key={idx} className="mb-5">
              {sidebarOpen && (
                <div className="px-2 mb-2 text-[10px] font-bold text-neutral-500 uppercase tracking-widest">
                  {section.section}
                </div>
              )}
                    ...
                    >
                      ...
                      {sidebarOpen && (
                        <>
                          ...
                          <ChevronRight className={`w-4 h-4 flex-shrink-0 ${isActive ? 'text-white' : 'text-neutral-600'}`} />
                        </>
                      )}
                    </Link>
                  );
